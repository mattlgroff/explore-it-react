...
<div className="container">
	...
	<div className="row">
		<div className="col-lg-3 col-md-6 col-sm-6 card-pad animated fadeInUp delay-02s">
			<div className="card bg-transparent flip">
				<div className="front hide-it-front bg-light">
					<img className="card-img-top mapImg" src={mat} alt="Matthew Groff" />
					<div className="card-body">
						...
						<img className="card-img-top mapImg icon-r" src="https://upload.wikimedia.org/wikipedia/commons/8/88/Simpleicons_Interface_arrow-curve-pointing-to-right-direction.svg" alt="FLIP" />
					</div>
				</div>
		...
		<div className="col-lg-3 col-md-6 col-sm-6 card-pad animated fadeInUp delay-04s">
			<div className="card bg-transparent flip">
				<div className="front hide-it-front bg-light">
					<img className="card-img-top mapImg" src={jak} alt="Jack Tamas" />
					<div className="card-body">
		...
		<div className="col-lg-3 col-md-6 col-sm-6 card-pad animated fadeInUp delay-05s">
			<div className="card bg-transparent flip">
				<div className="front hide-it-front bg-light">
					<img className="card-img-top mapImg" src={ike} alt="Ike Nnawuba" />
					<div className="card-body">
		...
		<div className="col-lg-3 col-md-6 col-sm-6 card-pad animated fadeInUp delay-05s">
			<div className="card bg-transparent flip">
				<div className="front hide-it-front bg-light">
					<img className="card-img-top mapImg" src={fjt} alt="FJT" />
					<div className="card-body">
